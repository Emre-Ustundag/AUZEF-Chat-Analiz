...
def test_satir_siniri_isaretlenir_ama_basarisiz_olmaz(settings: Settings) -> None:
    """Plan §3.2 (g): sınır aşılırsa iş BAŞARISIZ OLMAZ, yalnızca işaretlenir."""
    tight = Settings(max_rows=5)
    profile = validate_and_profile(FIXTURES / "valid_multi_sheet.xlsx", tight)
